...
export async function generateMetadata(): Promise<Metadata> {
  try {
    ...
    return { title: "Terms of Use | G Digital India", description: "Read our terms of use." };
  }
}

export default async function TermsOfUse() {
  let safePage: any = { title: 'Terms of Use', content: '<p>Please check back later.</p>' };
  try {
    const conn = await connectDB();
    if (conn) {
    ...
    console.error('⚠️ Terms of Use: DB fetch failed:', (err as Error).message);
  }
