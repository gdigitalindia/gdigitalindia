...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    if (!conn) return { title: 'Blog | G Digital India' };
    ...
    return { title: 'Blog | G Digital India' };
  }
}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '15px', padding: '15px 0', borderTop: '1px solid #222', borderBottom: '1px solid #222' }}>
            ...
            <div>
              ...
              <div style={{ fontSize: '13px', color: '#888', display: 'flex', alignItems: 'center', gap: '5px' }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round" style={{ color: '#c8a05a' }}>
