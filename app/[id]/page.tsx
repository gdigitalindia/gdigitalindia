    ...
    return (
      <div className={styles.page}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 24px 70px' }}>
          ...
          {(() => {
            const displayShorts = (industry.youtubeShorts && industry.youtubeShorts.length > 0)
              ? industry.youtubeShorts
            ...
            if (!displayShorts || displayShorts.length === 0) return null;
            ...
            return (
              <div className="dyn-shorts-wrap">
                ...
                <div className="dyn-shorts-grid">
                  {displayShorts.map((shortItem: any, idx: number) => {
